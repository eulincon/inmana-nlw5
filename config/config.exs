...
config :inmana, Inmana.Nailer, adapter: Bambook.LocalAdapter

# Configures the endpoint
config :inmana, InmanaWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "AHdLqn7h6GDz+O+vlvnIo56Ti/BVuPi3BfDsh5314alX7Omb7DCBSz1bvIWlrOlK",
  render_errors: [view: InmanaWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Inmana.PubSub,
  live_view: [signing_salt: "OfH/QP2g"]
